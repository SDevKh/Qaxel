...
const CATEGORIES = [
  ...
  { name: 'Pakistani Dresses', slug: 'pakistani-dresses', image: '/img/pakistani (1).jpeg', desc: 'Traditional and contemporary Pakistani dresses including lawn, chiffon, and formal wear.' },
